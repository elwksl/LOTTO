...
<link type="text/css" href="${path}/resources/css/reset.css" rel="stylesheet"/>
<link type="text/css" href="${path}/resources/css/style.css" rel="stylesheet"/>
<link type="text/css" href="${path}/resources/css/SpoqaHanSans-kr.css" rel="stylesheet"/>    
...
<script type='text/javascript' language='javascript' src="${path}/resources/js/jquery-ui.min2.js"></script>
...
<div class="game-645-wrap">
    <div class="game-645-header">
        <div class="current">
            <div class="now">
                <h2><span>제</span><strong  id="curRound"></strong><span>회</span></h2>
                <p><span>남은시간</span><strong id="countTime"><!-- 0일 00:00 --></strong></p>
            </div>
            <ul class="prize_and">
                <li><span>1등 예상 총 당첨금액</span><strong></strong></li>
                <li>&nbsp;</li>
            
            </ul>
        </div>
        <div class="past">
            <h3><strong></strong>회 당첨결과</h3>
            <p>
                <span class="ball "><span></span></span><!-- 볼 컬러 1~10 color1, 11~20 color2, 21~30 color3 31~40 color4, 41~45 color5 -->
        ...
        <div class="select-number">
            <div class="header">
                ...
                <ul id="tabWay2Buy">
               	...
               	<input type="hidden" id="ROUND_DRAW_DATE" name="ROUND_DRAW_DATE" value=""/>
               	<input type="hidden" id="WAMT_PAY_TLMT_END_DT" name="WAMT_PAY_TLMT_END_DT" value=""/>
            </div>
            <div class="ways">
                <!-- 번호선택/자동번호발급 -->
        ...
        <div class="selected-games">
            ...
            <div class="footer">
                <div class="set set1">
                    ...
                    <strong><span id="moneyBalance"></span><span>원</span></strong>
                </div>
                <div class="set set2">
                    <span>결제금액</span>
 ...
 */
    ...
    */
    ...
    //판매종료일 남은시간 카운트다운 샘플
    var lotteryDate = ""; //판매종료일 YYYYMMDDHHMMSS
